...
schoolid = 316
df_sub <- subset(df,
            (df[[paste0("belt_schoolid_", schoolid)]] == 1 | 
...
csv_name <- paste0("schoolid_", schoolid, "_belt_3yrs_complex_papanui+3",".csv")
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid,"_belt_3yrs_complex_burnside+3", ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid,"_belt_3yrs_complex_maori+5", ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "_belt_3yrs_complex_shirleyboys+3",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "_belt_3yrs_complex_avongirls+4",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "belt_3yrs_complex",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("riccarton+4_1000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("linwood+3_1000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("hornby+4_1000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("hill+5_1000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("chs+7_1000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
simpleformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(innerbelt_1000m_schoolid_343) + as.factor(threeyears_343) +    as.factor(inzone_schoolid_316) + as.factor(inzone_schoolid_319) + as.factor(inzone_schoolid_320) + as.factor(inzone_schoolid_321) + 
    as.factor(inzone_schoolid_324) + as.factor(inzone_schoolid_326) + as.factor(inzone_schoolid_327) + as.factor(inzone_schoolid_328) + 
    as.factor(inzone_schoolid_331) + as.factor(inzone_schoolid_336) + as.factor(inzone_schoolid_337) + 
...
# Construct the CSV file name
simplecsv_name <- paste0("1000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file

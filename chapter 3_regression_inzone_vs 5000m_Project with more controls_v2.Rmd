...
schoolid = 316
df_sub <- subset(df,
            (df[[paste0("outerbelt_5000m_schoolid_", schoolid)]] == 1 | 
             df[[paste0("inzone_schoolid_", schoolid)]] == 1)) 
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(inzone_schoolid_316) * as.factor(threeyears_316) + 
      as.factor(inzone_schoolid_316) + as.factor(threeyears_316) + 
...
csv_name <- paste0("schoolid_", schoolid, "_5000m_3yrs_complex_papanui+3",".csv")
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_319) * as.factor(threeyears_319) + 
      as.factor(inzone_schoolid_319) + as.factor(threeyears_319) +     
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid,"_5000m_3yrs_complex_burnside+3", ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_320) * as.factor(threeyears_320) + 
      as.factor(inzone_schoolid_320) + as.factor(threeyears_320)+ 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid,"_5000m_3yrs_complex_maori+5", ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_321) * as.factor(threeyears_321) + 
      as.factor(inzone_schoolid_321) + as.factor(threeyears_321) +   as.factor(inzone_schoolid_316) + as.factor(inzone_schoolid_320) + 
    as.factor(inzone_schoolid_324) + as.factor(inzone_schoolid_326) + as.factor(inzone_schoolid_327) + as.factor(inzone_schoolid_328) + as.factor(inzone_schoolid_336) +as.factor(inzone_schoolid_337)  + as.factor(inzone_schoolid_343)
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "_5000m_3yrs_complex_shirleyboys+3",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_324) * as.factor(threeyears_324) + 
      as.factor(inzone_schoolid_324) + as.factor(threeyears_324)  + as.factor(inzone_schoolid_316) + as.factor(inzone_schoolid_320) + 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "_5000m_3yrs_complex_avongirls+4",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) + 
    ...
    as.factor(inzone_schoolid_326) * as.factor(threeyears_326) + 
    as.factor(inzone_schoolid_326) + as.factor(threeyears_326) + 
    as.factor(inzone_schoolid_316)  + as.factor(inzone_schoolid_321) + 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "5000m_3yrs_complex",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_327) * as.factor(threeyears_327) + 
      as.factor(inzone_schoolid_327) + as.factor(threeyears_327) + 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("chboys+6_5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```    
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_328) * as.factor(threeyears_328) + 
      as.factor(inzone_schoolid_328) + as.factor(threeyears_328) + 
  as.factor(inzone_schoolid_316) + as.factor(inzone_schoolid_319) + as.factor(inzone_schoolid_320) + as.factor(inzone_schoolid_321) + 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("chchgirls+6_5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_334) * as.factor(threeyears_334) + 
      as.factor(inzone_schoolid_334) + as.factor(threeyears_334) + 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("riccarton+4_5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_336) * as.factor(threeyears_336) + 
      as.factor(inzone_schoolid_336) + as.factor(threeyears_336)+ 
 as.factor(inzone_schoolid_316) + as.factor(inzone_schoolid_319) + as.factor(inzone_schoolid_320) + as.factor(inzone_schoolid_321) + 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("hagley+6_5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_337) * as.factor(threeyears_337) + 
      as.factor(inzone_schoolid_337) + as.factor(threeyears_337)+ 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("linwood+3_5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_338) * as.factor(threeyears_338) + 
      as.factor(inzone_schoolid_338) + as.factor(threeyears_338)+
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("hornby+4_5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_339) * as.factor(threeyears_339) + 
      as.factor(inzone_schoolid_339) + as.factor(threeyears_320)+ 
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("hill+5_5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_340) * as.factor(threeyears_340) + 
      as.factor(inzone_schoolid_340) + as.factor(threeyears_340) +
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("chs+7_5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
simpleformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(inzone_schoolid_343) * as.factor(threeyears_343) + 
      as.factor(inzone_schoolid_343) + as.factor(threeyears_343) +    as.factor(inzone_schoolid_316) + as.factor(inzone_schoolid_319) + as.factor(inzone_schoolid_320) + as.factor(inzone_schoolid_321) + 
    as.factor(inzone_schoolid_324) + as.factor(inzone_schoolid_326) + as.factor(inzone_schoolid_327) + as.factor(inzone_schoolid_328) + 
    as.factor(inzone_schoolid_331) + as.factor(inzone_schoolid_336) + as.factor(inzone_schoolid_337) + 
...
# Construct the CSV file name
simplecsv_name <- paste0("5000m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file

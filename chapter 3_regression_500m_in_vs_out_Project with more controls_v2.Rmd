...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(innerbelt_500m_schoolid_316) * as.factor(threeyears_316) + 
      as.factor(innerbelt_500m_schoolid_316) + as.factor(threeyears_316) + 
...
complexformula <- lp ~ CL_Building_Floor_Area + CL_Land_Area + as.factor(CL_Bedrooms) +as.factor(CL_Bathrooms) + 
      ...
      as.factor(CL_MAS_No_Main_Roof_Garages) + as.factor(CL_LUD_Land_Use_Description)  + 
      as.factor(CL_MAS_Contour) + as.factor(year) + as.factor(quarter) + 
      as.factor(innerbelt_500m_schoolid_319) * as.factor(threeyears_319) + 
      as.factor(innerbelt_500m_schoolid_319) + as.factor(threeyears_319) +     
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid,"_500m_3yrs_complex_burnside+3", ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid,"_500m_3yrs_complex_maori+5", ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "_500m_3yrs_complex_shirleyboys+3",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "_500m_3yrs_complex_avongirls+4",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("schoolid_", schoolid, "500m_3yrs_complex",".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("chboys+6_500m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```    
...
model_table <- etable(model)
# Construct the CSV file name
csv_name <- paste0("chchgirls+6_500m_3yrs_complex_schoolid_", schoolid, ".csv")
# Save the table as a CSV file
write.csv(model_table, file = csv_name, row.names = TRUE)
```
